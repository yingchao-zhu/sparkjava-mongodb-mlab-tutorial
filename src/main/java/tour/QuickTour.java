...
/* 
 From https://github.com/mongodb/mongo-java-driver
  mongo-java-driver/driver-sync/src/examples/tour/QuickTour.java
...
public class QuickTour {
    ...
    public static void main(final String[] args) {
        ...
        MongoDatabase database = mongoClient.getDatabase(System.getenv("DB_NAME"));
